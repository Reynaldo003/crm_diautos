  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative overflow-hidden rounded-lg bg-[linear-gradient(135deg,#0B1120_0%,#0F172A_60%,#0D1526_100%)] px-5 py-5 shadow-xl sm:px-7 lg:px-8">
        {/* brillo suave igual que PlaceholderPage */}
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h1 className="mt-3 text-[2.2rem] font-black leading-none tracking-tight text-white sm:text-[3rem] lg:text-[3.4rem]">
              Administración general de cartera
            </h1>
            {permisos.esAsesorBDC && (
              <p className="mt-2 text-sm font-semibold text-white/55">
                Vista restringida: solo se muestran los VINs asignados a tu usuario.
              </p>
            )}
            <div className="mt-4">
      ...
      {permisos.puedeAdministrarAsignacion && (
        <SeccionAsignacion
          ...
          onActualizar={() => cargarCartera(paginaActual)}
        />
      )}
...
function SeccionAsignacion({ asesores, asesoresSeleccionados, filtrosAsignacion, ventasDisponibles, resumenDisponibles, preview, cargandoDisponibles, cargandoAccion, onToggleAsesor, onCambiarFiltro, onSimular, onAsignar, onActualizar }) {
  return (
